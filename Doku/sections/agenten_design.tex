...
Aus 280 Baseline-Zuständen und 471 möglichen Count-Kontexten ergibt sich
eine encoderbasierte Obergrenze von 131.880 Zuständen der Q-Tabelle; da
nicht jede Kombination physisch erreichbar sein muss, ist sie keine exakte
Zustandszahl (siehe Anhang~\ref{sec:counting_upper_bound}).
