...
\end{equation}
Zur Begrenzung des Zustandsraums werden die Zusatzmerkmale diskretisiert. Dabei bezeichnet $\operatorname{trunc}$ die im Code verwendete Ganzzahlumwandlung, die Nachkommastellen gegen null abschneidet:
\begin{align}
...
\toprule
\textbf{Stufe} & \textbf{Konfigurationen} & \textbf{Trainingsseeds} & \textbf{Training} & \textbf{Greedy Evaluation}\\
\midrule
...
Für den finalen Lauf wurde die Counting-Konfiguration \texttt{c05\_long\_default} ausgewählt. Sie war in Stufe C mit einem mittleren Reward von $-0{,}05259$ die beste Counting-Variante und zeigte mit einer Seed-Standardabweichung von $0{,}00052$ die höchste Stabilität der untersuchten Counting-Konfigurationen. Die Baseline lag bei 20 Millionen Episoden mit $-0{,}04906$ dennoch vorn. Das sprach dafür, dem größeren Counting-Zustandsraum erheblich mehr Training zu geben.
...
$\epsilon$-Decay & Linear über 90\,\% der 100 Mio. Episoden, danach konstant\\
